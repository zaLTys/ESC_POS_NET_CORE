...
using ESC_POS_NET_CORE.Epson_Commands;
using ESC_POS_NET_CORE.Helper;
using ESC_POS_NET_CORE.Interfaces.Command;
using ESC_POS_NET_CORE.Interfaces.Printer;

namespace ESC_POS_NET_CORE
{
    public class Printer : IPrinter
    {
        ...
        public Printer(string printerName = "BIXOLON SRP-E300",string codepage = "Windows-1257")
        {
        ...
        private void AppendString(string value, bool useLf)
        {
            ...
            var bytes = Encoding.GetEncoding(1257).GetBytes(value);
            list.AddRange(bytes);
            _buffer = list.ToArray();
        }
